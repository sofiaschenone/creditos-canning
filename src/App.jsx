import { ShieldCheck, Clock, CheckCircle2, Landmark, Users, Briefcase, MessageCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0D0B0E] text-slate-200 font-sans selection:bg-[#4C4424] selection:text-white">
      ...
      <header className="fixed w-full bg-[#0D0B0E]/90 backdrop-blur-md z-50 border-b border-[#151415]">
        <div className="max-w-6xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <WhatsAppButton text="Consultar ahora" className="px-5 py-2 text-sm" iconSize={20} />
          </div>
        </div>
      </header>
      ...
      <section className="py-20 px-4 bg-[#121013]/60 border-y border-[#151415] relative">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-slate-400 text-sm mb-12">Pasá el cursor sobre cada tarjeta para conocer cuotas y requisitos.</p>
      ...
      <footer className="py-12 px-4 text-center bg-[#0D0B0E] border-t border-[#151415]">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            {/* Instagram SVG */}
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-3 bg-[#121013] rounded-full border border-[#151415] text-amber-400 hover:border-[#4C4424] hover:scale-110 transition-all flex items-center justify-center" aria-label="Instagram">
            ...
            {/* Facebook SVG */}
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-3 bg-[#121013] rounded-full border border-[#151415] text-amber-400 hover:border-[#4C4424] hover:scale-110 transition-all flex items-center justify-center" aria-label="Facebook">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/5491158759573" target="_blank" rel="noopener noreferrer" className="p-3 bg-[#121013] rounded-full border border-[#151415] text-amber-400 hover:border-[#4C4424] hover:scale-110 transition-all flex items-center justify-center" aria-label="WhatsApp">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <WhatsAppButton text="" className="p-4 rounded-full shadow-[0_0_25px_rgba(34,197,94,0.6)]" iconSize={28} />
      </div>
